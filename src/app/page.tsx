      ...
      <div className="flex-grow">
        <section className="relative z-10 py-24 flex-grow">
          <div className="container mx-auto px-4">
            ...
            {/* Decorative Corner ONLY */}
            <div className="absolute -top-20 left-0 h-30 w-100 border-l-2 border-t-2 border-border" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
              ...
              <div className="lg:col-span-6 space-y-8 relative z-10">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
                  ...
                  <div><span className="text-foreground pt-2">With Advance</span></div>
                  <div className="pt-2">
                    <span className="text-foreground mr-4">AI</span>
